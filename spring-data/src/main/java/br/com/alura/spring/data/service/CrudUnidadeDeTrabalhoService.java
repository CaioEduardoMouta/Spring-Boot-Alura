...
public class CrudUnidadeDeTrabalhoService {
	...
	private final UnidadeDeTrabalhoRepository unidadeTrabalhoRepository;
	
	public CrudUnidadeDeTrabalhoService(UnidadeDeTrabalhoRepository unidadeTrabalhoRepository) {
